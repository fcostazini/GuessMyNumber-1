...
public class MenuActivity extends ActionBarActivity {
    ...
    public void connect() {
        this.connectManager = new ConnectManager(new ManagerFactory(R.string.client_url));
        this.connectManager.connect(((GameApplication) this.getApplicationContext()).getUser());
    }
