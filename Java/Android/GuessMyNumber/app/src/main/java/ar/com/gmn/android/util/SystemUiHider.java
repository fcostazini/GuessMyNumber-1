...
public abstract class SystemUiHider {
	...
	/**
	 * Creates and returns an instance of {@link ar.com.gmn.android.util.SystemUiHider} that is
	 ...
	 *            this class.
	 * @param anchorView
	 *            The view on which {@link android.view.View#setSystemUiVisibility(int)} will
	 *            be called.
	 * @param flags
