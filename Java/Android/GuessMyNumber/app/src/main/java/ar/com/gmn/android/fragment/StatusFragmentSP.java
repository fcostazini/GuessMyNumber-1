...
public class StatusFragmentSP extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_help_table_sp, null);
	...
	public TextView createEmptyText(View view, Typeface type, String text) {
		...
		tx.setTextAppearance(view.getContext(), R.style.CellHelpTableSP);
		tx.setBackgroundResource(R.drawable.cell_borders_sp);
		tx.setTypeface(type);
